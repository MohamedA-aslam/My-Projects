...
{
%>
<h3 class="alert">Product added your cart Successfully!</h3>
<% } %>
<%
...
{
%>
<h3 class="alert">Thank you , purchasing using our service.</h3>
<% } 
%>
...
%>
<h3 class="alert">Welcome , <%= customerName %>  </h3>
<% 
}
if("welcomeback".equals(msg)){
%>
<h3 class="alert">Welcome back, <%= customerName %></h3>
<%
}
%>
...
<table id="customers">
      ...
      %> 
          ...
          <tr>
            ...
            <td><a href="AddToCartAction?id=<%= rs.getInt(1) %>">Add to cart <i class='fas fa-cart-plus'></i></a></td>
          </tr>
<%
    		}
