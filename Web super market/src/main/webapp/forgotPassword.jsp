...
<body><br><br><h2>Online Super Market </h2><hr><br><br>
  ...
  <div class='login'>
     <form action="ForgotPasswordAction" method="post">
    	<input type="number" name="phoneNumber" placeholder="Enter Your Phone Number" class="form-control" required="required"><br>
   		...
   		<input type="password" name="newPassword" id="txtConfirmPassword" placeholder="Confirm Your new password "  class="form-control" required="required"><br>
     	<input type="submit" class="btn btn-success" onclick="return Validate()"  value="submit">
     </form>
